...
final class GreetingController extends Controller
{
    ...
    {
        return $this->render('@VaaCharSyliusShippingInformationPagePlugin/static_greeting.html.twig', ['greeting' => $this->getGreeting($name)]);
    }
    ...
    {
        return $this->render('@VaaCharSyliusShippingInformationPagePlugin/dynamic_greeting.html.twig', ['greeting' => $this->getGreeting($name)]);
    }
